  ...
  return (
    <div className="max-w-3xl mx-auto pt-10">
      ...
      <div className="prose prose-lg max-w-none text-text-secondary">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-text-default mb-4">2. Services</h2>
          <p className="mb-4">
            Antibroadcasting provides custom screen printing services including but not limited to:
          </p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-text-default mb-4">5. Artwork and Copyright</h2>
          <p className="mb-4">
            By providing artwork for printing, you represent and warrant that:
          </p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>You own the rights to the artwork or have permission to use it</li>
            <li>The artwork does not infringe on any third-party rights</li>
            <li>You grant us a limited license to use the artwork solely for production</li>
          </ul>
        </section>
